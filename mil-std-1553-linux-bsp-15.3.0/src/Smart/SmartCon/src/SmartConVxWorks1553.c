...
#if 1
    /* normal update */
    char *argv[4] = {"SMART", "-u", "AIM/Mil1553/SRE/update.upd", "update"};
    int  argc = 4;
#endif

#if 0
    /* normal update */
    char *argv[3] = {"SMART", "-u", "AIM/Mil1553/SRE/update.upd"};
    int  argc = 3;
#endif

#if 0
    /* force update */
    char *argv[5] = {"SMART", "--force", "-u", "AIM/Mil1553/SRE/update.upd", "update"};
    int  argc = 5;
#endif
