    ...
    AiUInt32          ulMaxSizeDecoded)
{
    ...
    wRetVal = MyMonCmdExecuteAsync(pContext, MYMON_CMD_UPDATE_SET, 5, ulInput);
                                          ...
                                          AiUInt32       * pulStatus)
{
    ...
    wRetVal = MyMonCmdExecuteAsyncGetStatus(pContext, MYMON_CMD_UPDATE_SET, 2, ulOutput);
    ...
    if ((wRetVal == MYMON_OK) && (ulOutput[0] != MYMON_PASS))
    {
        wRetVal = MYMON_ERR_STATUS;
    }
